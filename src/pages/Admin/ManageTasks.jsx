      ...
      <div className="my-5">
        <div className="flex flex-col lg:flex-row justify-between lg:items-center mb-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              className="lg:hidden flex items-center download-btn py-2 px-4 bg-blue-600 text-white rounded-lg"
          ...
          {allTasks.length > 0 && (
            <div className="flex items-center gap-3 mt-4 lg:mt-0">
              ...
              <button
                className="hidden lg:flex items-center download-btn py-2 px-4 bg-blue-600 text-white rounded-lg"
                onClick={handleDownloadReport}
              >
                <LuFileSpreadsheet className="text-lg mr-2" />
                Download Report
